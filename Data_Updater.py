...
def RouteMap_Updater():
    ...
    print(f"臺北市站序資訊Status:{StatusCode}")
    SaveContent(Path, Buffer)

    Path = "./RouteInfo/NWT_RouteMap.json"
    print(f"新北市站序資訊Status:{StatusCode}")
...
def StationInfo_Updater():
    ...
    print(f"臺北市站位資訊Status:{StatusCode}")
    SaveContent(Path, Buffer)

    Path = "./RouteInfo/NWT_Station.json"
    print(f"新北市站位資訊Status:{StatusCode}")
...
def StopInfo_Updater():
    ...
    print(f"臺北市站牌資訊Status:{StatusCode}")
    SaveContent(Path, Buffer)

    Path = "./RouteInfo/NWT_Stop.json"
    print(f"新北市站牌資訊Status:{StatusCode}")
